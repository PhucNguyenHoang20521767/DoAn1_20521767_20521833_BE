...
async function createCatchphrase(body) {
    ...
    try {
        ...
        return { success: false, message: "Failed to create catchphrase" };
    }
}
...
async function updateCatchphrase(id, movieName = null, reqCatchphrase = null, movieContext = null) {
    ...
    try {
        ...
        try {
            ...
            return { sucess: false ,message: "Failed to update catchphrase" };
        }
    } catch (err) {
        return { success: false, message: err.message };
    }
